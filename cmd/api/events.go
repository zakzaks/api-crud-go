...
func (app *application) addAttendeeToEvent(c *gin.Context) {
	...
	userToAdd, err := app.models.User.GetById(userId)
	if err != nil {
...
func (app *application) deleteAttendeeFromEvent(c *gin.Context) {
	...
	user := app.getUserFromContext(c)
	if event.OwnerId != user.Id {
		c.JSON(http.StatusInternalServerError, gin.H{"error": "You do not have permission to delete attendees from this event"})
		return
	}
	...
	if err := app.models.Attendees.Delete(userId, id); err != nil {
